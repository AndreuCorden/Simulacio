...
BATCH_SIZE = 200 
AVG_TOTAL_TIME_ALL_SIMULATIONS = 0.0
...
class StatisticsCollector:
    ...
    def report(self):
        global AVG_TOTAL_TIME_ALL_SIMULATIONS
        ...
        if self.system_times:
            ...
            AVG_TOTAL_TIME_ALL_SIMULATIONS = AVG_TOTAL_TIME_ALL_SIMULATIONS + sum(self.system_times) / len(self.system_times)
...
if __name__ == '__main__':
    ...
    AVG_TOTAL_TIME_ALL_SIMULATIONS = AVG_TOTAL_TIME_ALL_SIMULATIONS/i
    print(f"AVG_TOTAL_TIME_ALL_SIMULATIONS = {AVG_TOTAL_TIME_ALL_SIMULATIONS}")
